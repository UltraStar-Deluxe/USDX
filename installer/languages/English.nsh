...
;${LangFileString} name_section3 "Themes"
${LangFileString} name_section4 "UltraStar-Manager"
${LangFileString} name_section5 "UltraStar-Creator"
...
;${LangFileString} DESC_Section3 "This will install additional themes."
${LangFileString} DESC_Section4 "This will install UltraStar Manager, a tool to easily manage your ${name} song collection."
${LangFileString} DESC_Section5 "This will install UltraStar Creator, a tool to create your own songs for ${name}."
