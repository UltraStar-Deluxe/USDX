...
LangString update_information ${LANG_ENGLISH} "You can check if a new version of 'UltraStar Deluxe WorldParty' is available. Thereto an internet connection will be established. If a new version is found, it can be installed afterwards."
...
LangString page_welcome_title_update ${LANG_ENGLISH} "Welcome to the UltraStar Deluxe WorldParty Update Wizard"
LangString page_welcome_txt_update ${LANG_ENGLISH} "This wizard will guide you through the Update process of UltraStar Deluxe WorldParty. UltraStar Deluxe is a free open source Karaoke game, which can be compared with Singstar.$\n$\r$\n$\rThe UltraStar Deluxe Team and zup3r_vock (WorldParty Mod) wishes you fun.$\n$\rProject website: http://www.ultrastardeluxe.org$\n$\rSupport Forum: http://forum.ultrastardeluxe.org"
LangString page_welcome_title ${LANG_ENGLISH} "Welcome to the UltraStar Deluxe WorldParty Setup Wizard"
LangString page_welcome_txt ${LANG_ENGLISH} "This wizard will guide you through the Installation of UltraStar Deluxe WorldParty. UltraStar Deluxe is a free open source Karaoke game, which can be compared with Singstar.$\n$\r$\n$\rThe UltraStar Deluxe Team and zup3r_vock (WorldParty Mod) wishes you fun.$\n$\rProject website: http://www.ultrastardeluxe.org$\n$\rSupport Forum: http://forum.ultrastardeluxe.org"
LangString page_un_welcome_title ${LANG_ENGLISH} "Welcome to the UltraStar Deluxe WorldParty uninstall wizard"
...
LangString page_settings_subtitle ${LANG_ENGLISH} "Specify your favorite settings for UltraStar Deluxe WorldParty."

; Finish Page:

LangString page_finish_txt ${LANG_ENGLISH} "UltraStar Deluxe WorldParty was installed successfully on you system.$\n$\r$\n$\rVisit out project website to get latest news and updates."
...
LangString sm_shortcut ${LANG_ENGLISH} "Play UltraStar Deluxe WorldParty"
...
LangString DESC_Section1 ${LANG_ENGLISH} "These are the basic files needed by UltraStar Deluxe WorldParty"
