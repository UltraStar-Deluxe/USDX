...
${LangFileString} update_download_invalid_installer "Pobieranie nowej wersji $online_version nie powiodło się. Pobrany instalator jest nieprawidłowy. Mogło to nastąpić, jeśli serwer/strona napotkała problemy, już nie istnieje, lub jest w trakcie konserwacji.$\r$\n$\r$\nProszę, odwiedź naszą stronę ${homepage} i pobierz instalator ręcznie."${LangFileString} update_download_none "Nie wybrano wersji do pobrania. Instalator nie może zaktualizować twojej wersji. Odwiedź naszą stronę ${homepage}, aby uzyskać najnowsze informacje i aktualizacje."
