...
${LangFileString} oninit_closeusdx "kann nicht während der Laufzeit deinstalliert werden. Soll es geschlossen werden?"
${LangFileString} oninit_updateusdx "Möchtest du das Programm aktualisieren von"
...
${LangFileString} page_components_info "Bewege den Mauszeiger über die Komponente um Details einzusehen"
...
${LangFileString} page_finish_linktxt "Projektwebseite"
...
${LangFileString} name_section1 "Hauptkomponenten"
...
${LangFileString} DESC_Section1 "Dies sind die von ${name} benötigten Grunddateien"
${LangFileString} DESC_Section2 "Hier können Songs zum Herunterladen gewählt werden. (Benötigt aktive Internetverbindung!)"
${LangFileString} DESC_Section2_sub1 "Hier können Jonathan Coulton Songs (CC by-nc 3.0) zum Herunterladen gewählt werden."
${LangFileString} DESC_Section2_sub2 "Hier können Shearer Songs (CC by-nc-sa 2.0 / 3.0) zum Herunterladen gewählt werden."
...
${LangFileString} DESC_g2Section4 "Lädt das Lied 'Pornophonique - Space Invaders' (CC by-nc-nd 2.0) herunter."
${LangFileString} DESC_g2Section5 "Lädt das Lied 'Steven Dunston - Northern Star' (CC by-nc-sa 2.5) herunter."
${LangFileString} DESC_g2Section1 "Lädt das Lied 'Bodo Wartke - Liebeslied (Love Song)' herunter."
${LangFileString} DESC_g2Section6 "Lädt das Lied 'Pornophonique - Space Invaders (Karaoke)' (CC by-nc-nd 2.0) herunter."

${LangFileString} DESC_s2_sub1_Section1 "Lädt das Lied 'Monkey Shines' herunter."
${LangFileString} DESC_s2_sub1_Section2 "Lädt das Lied 'I Crush Everything' herunter."
${LangFileString} DESC_s2_sub1_Section3 "Lädt das Lied 'Not About You' herunter."
${LangFileString} DESC_s2_sub1_Section4 "Lädt das Lied 'Mr. Fancy Pants' herunter."
${LangFileString} DESC_s2_sub1_Section5 "Lädt das Lied 'Big Bad World One' herunter."
${LangFileString} DESC_s2_sub1_Section6 "Lädt das Lied 'Flickr [inkl. Video]' herunter."
${LangFileString} DESC_s2_sub1_Section7 "Lädt das Lied 'My Beige Bear' herunter."
${LangFileString} DESC_s2_sub1_Section8 "Lädt das Lied 'The Future Soon' herunter."
${LangFileString} DESC_s2_sub1_Section9 "Lädt das Lied 'Ikea' herunter."
${LangFileString} DESC_s2_sub1_Section10 "Lädt das Lied 'Furry Old Lobster' herunter."
${LangFileString} DESC_s2_sub1_Section11 "Lädt das Lied 'Code Monkey [inkl. Video]' herunter."
${LangFileString} DESC_s2_sub1_Section12 "Lädt das Lied 'I´m Your Moon' herunter."
${LangFileString} DESC_s2_sub1_Section13 "Lädt das Lied 'First Of May' herunter."
${LangFileString} DESC_s2_sub1_Section14 "Lädt das Lied 'Dance, Soterios Johnson, Dance' herunter."
${LangFileString} DESC_s2_sub1_Section15 "Lädt das Lied 'A Talk With George' herunter."
${LangFileString} DESC_s2_sub1_Section16 "Lädt das Lied 'Creepy Doll [inkl. Video]' herunter."
${LangFileString} DESC_s2_sub1_Section17 "Lädt das Lied 'That Spells DNA' herunter."
${LangFileString} DESC_s2_sub1_Section18 "Lädt das Lied 'When You Go' herunter."
${LangFileString} DESC_s2_sub1_Section19 "Lädt das Lied 'Better' herunter."
${LangFileString} DESC_s2_sub1_Section20 "Lädt das Lied 'Shop Vac' herunter."
${LangFileString} DESC_s2_sub1_Section21 "Lädt das Lied 'I Feel Fantastic' herunter."
${LangFileString} DESC_s2_sub1_Section22 "Lädt das Lied 'Re: Your Brains' herunter."
${LangFileString} DESC_s2_sub1_Section23 "Lädt das Lied 'Skullcrusher Mountain' herunter."
${LangFileString} DESC_s2_sub1_Section24 "Lädt das Lied 'Chiron Beta Prime [inkl. Video]' herunter."

${LangFileString} DESC_s2_sub2_Section1 "Lädt das Lied '69' herunter."
${LangFileString} DESC_s2_sub2_Section2 "Lädt das Lied '69 (Karaoke)' herunter."
${LangFileString} DESC_s2_sub2_Section3 "Lädt das Lied 'Can't stop it' herunter."
${LangFileString} DESC_s2_sub2_Section4 "Lädt das Lied 'Can't stop it (Karaoke)' herunter."
${LangFileString} DESC_s2_sub2_Section5 "Lädt das Lied 'In My Hand' herunter."
${LangFileString} DESC_s2_sub2_Section6 "Lädt das Lied 'Man Song' herunter."
...
${LangFileString} DESC_s2_sub3_Section3 "Lädt das Lied 'Mensch, wo bist du? (Karaoke)' herunter."
