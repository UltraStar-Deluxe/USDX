...
{$ifndef FF_API_FILESIZE}
  FF_API_FILESIZE = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_MUXRATE}
  FF_API_MUXRATE = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_RTSP_URL_OPTIONS}
  FF_API_RTSP_URL_OPTIONS = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_NEW_STREAM}
  FF_API_NEW_STREAM = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_PRELOAD}
  FF_API_PRELOAD = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_STREAM_COPY}
  FF_API_STREAM_COPY = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_SEEK_PUBLIC}
  FF_API_SEEK_PUBLIC = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_REORDER_PRIVATE}
  FF_API_REORDER_PRIVATE = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_OLD_INTERRUPT_CB}
  FF_API_OLD_INTERRUPT_CB = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
{$ifndef FF_API_SET_PTS_INFO}
  FF_API_SET_PTS_INFO = (LIBAVFORMAT_VERSION_MAJOR < 54);
{$endif}
