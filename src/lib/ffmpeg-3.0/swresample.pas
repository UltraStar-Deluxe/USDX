...
const
  ...
  LIBSWRESAMPLE_MAX_VERSION_MAJOR   = 2;
  LIBSWRESAMPLE_MAX_VERSION_MINOR   = 0;
  LIBSWRESAMPLE_MAX_VERSION_RELEASE = 101;
  ...
  LIBSWRESAMPLE_MIN_VERSION_MAJOR   = 2;
  LIBSWRESAMPLE_MIN_VERSION_MINOR   = 0;
  LIBSWRESAMPLE_MIN_VERSION_RELEASE = 101;
