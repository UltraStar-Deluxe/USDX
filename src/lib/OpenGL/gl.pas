...
//ToDo basisbit: switch from moduleloader to SDL_GL_LoadLibrary(), see https://wiki.libsdl.org/SDL_GL_LoadLibrary
{
...
begin
  ...
  if SDL_GL_LoadLibrary(0) = 0 then
  begin
    ...
    {$IFDEF WINDOWS}
    @ChoosePixelFormat := SDL_GL_GetProcAddress('ChoosePixelFormat');
