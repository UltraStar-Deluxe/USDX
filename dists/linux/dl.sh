...
deps+=('ffmpeg,https://ffmpeg.org/releases/ffmpeg-2.8.11.tar.gz')
...
deps+=('libpng,https://sourceforge.net/projects/libpng/files/libpng16/1.6.28/libpng-1.6.28.tar.gz/download')
